...
logger = get_logger("dashboard.ws_gateway")
...
class WebSocketTelemetryGateway:
    ...
    async def handle_connection(
        self, websocket: WebSocket, api_key: str | None = None
    ) -> None:
    ...
    async def _handle_eventbus_delta(
    ...
    async def _send_frame(
        self, ws: WebSocket, frame_type: str, data: dict[str, Any]
    ) -> None:
        frame = {
            "type": frame_type,
            "data": data,
